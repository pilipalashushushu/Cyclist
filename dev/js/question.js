...
function bikeIn(){
  ...
  var pmovein = new TimelineMax({
  })
  pmovein.to('.bicycle',2,{
    x:500,
  }).to('.qa',1,{
    css:{
      opacity:1
  ...
  //////////答題正確出去開始//////////
  function rightOut (){
    var rmoveout = new TimelineMax({})
    rmoveout.to('.rightBox',1,{
      css:{
    ...
    //////////答題錯誤出去開始//////////
    function wrongOut (){
      var wmoveout = new TimelineMax({})
      wmoveout.to('.wrongBox',1,{
        css:{
  ...
  function bikeInRwd(){ 
    ...
    var rmovein = new TimelineMax({})
    rmovein.to('.bicycle',2,{
      x:550,
      ease: Power0.easeNone,
    }).to('.qa',.3,{
      css:{
